import svgPaths from "./svg-xtzvh5e7gk";
...
function Input() {
  return (
    <div className="absolute bg-[#e4e2e0] content-stretch flex items-start justify-center left-0 overflow-clip px-[16px] py-[14px] right-[0.16px] rounded-[6px] top-[22.5px]" data-name="Input">
      <Container13 />
    </div>
  );
}
      ...
      <div className="flex flex-row items-center justify-center size-full">
        <div className="content-stretch flex items-center justify-center px-[16px] py-[12px] relative size-full">
          <div className="flex flex-col justify-center overflow-clip rounded-[inherit] size-full">
            <div className="content-stretch flex flex-col items-start justify-center pl-[416px] pr-[8px] py-[12px] relative size-full">
              <Svg />
            </div>
          </div>
          <Container18 />
...
function Container17() {
  return (
    <div className="absolute content-stretch flex flex-col items-start left-0 right-[0.16px] top-[22.5px]" data-name="Container">
      <Options />
      <Container19 />
    </div>
  );
...
function Background1() {
  return (
    <div className="bg-white col-[7/span_6] justify-self-stretch relative row-1 self-start shrink-0" data-name="Background">
