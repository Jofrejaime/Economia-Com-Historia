import svgPaths from "./svg-vpdt0cnbmp";
import  from "./8c711ec32be972eef06cb0eef1620adc2b98ee6c.png";
...
function () {
  return (
    <div className="flex-[1_0_0] min-h-px relative w-full" data-name="AB6AXuA5-JAVSyIXN52YjTomhPGtloHlm3rdywQLpL9bdrHJo4FmmdirXgAzViSthQw7j6o5kxtOIoSRlJkgcIAz5oKDB4aLhSzvkcmYBqdwJLdxYz-RSPXXy7cdV2NbRbb3t7u1sYf8yC1fHvCAR8b4vQ6XXAwwELRKDrOg5whOR8hxa9DVXAlQWj9YTxOhL29ltX7XXifQ97iSHsDDLe4Jb8SeSR4eDMErw0Ll2bOW6wvRHrPl5rs-gCPgnRtZ8cbJJLngj0XpUPe6JCM">
      <div className="absolute inset-0 overflow-hidden pointer-events-none">
        <img alt="" className="absolute h-[133.33%] left-[0.75%] max-w-none top-[-1.54%] w-full" src={} />
      </div>
    </div>
  );
}
...
function Background() {
  return (
    <div className="bg-[#8b1e2d] content-stretch flex flex-col items-start justify-center overflow-clip relative rounded-[12px] shrink-0 size-[32px]" data-name="Background">
      < />
    </div>
  );
}
...
function TopNavBarNavigationShell() {
  return (
    <div className="backdrop-blur-[32px] bg-[rgba(255,255,255,0.85)] max-w-[1536px] relative shrink-0 w-full" data-name="TopNavBar Navigation Shell">
      <div className="flex flex-row items-center max-w-[inherit] size-full">
        <div className="content-stretch flex items-center justify-between max-w-[inherit] pl-[48px] pr-[48.01px] py-[24px] relative size-full">
          <Container />
          <Container1 />
          <Container2 />
        </div>
...
function () {
  return (
    <div className="h-[260px] relative shrink-0 w-full" data-name="AB6AXuDvviFw-bu7HYcLeIOg8SpevLVAXw1pH4NshTJy5SXB91AHKobaXpYlybX9oYArijMS7jsDNGTz3amGJaDRjoix-4l9oEGyZgfqKLf3WqY4IkpgQpL9HARda8qVhSXbZxuBdRhmtg35veUjRF8KLlGXiswwDNRsZrhW_nSwxY9-wYweRxw5-8ruetok2R4JDGY1HOisQnS73xLSMV9DfgvcDPCvaJb1UhowQLf1R9afkrlgq_dChD4GxUoQ9NrR3fjvBKEi894IyzY">
      <div className="absolute inset-0 overflow-hidden pointer-events-none">
        <img alt="" className="absolute h-[133.33%] left-[-0.05%] max-w-none top-[-1.61%] w-full" src={} />
      </div>
    </div>
  );
}
...
function BackgroundShadow() {
  return (
    <div className="bg-[#dee9fc] col-[1/span_3] content-stretch flex flex-col items-start justify-center justify-self-stretch overflow-clip relative rounded-[8px] row-1 self-end shadow-[0px_1px_2px_0px_rgba(0,0,0,0.05)] shrink-0" data-name="Background+Shadow">
      < />
    </div>
  );
}
...
function Container5() {
  return (
    <div className="content-stretch flex flex-col items-start relative shrink-0 w-full" data-name="Container">
      <div className="flex flex-col font-['Source_Sans_3:Bold',sans-serif] font-bold justify-center leading-[0] relative shrink-0 text-[#6b0119] text-[11px] tracking-[1.1px] uppercase w-full">
        <p className="leading-[16.5px]">ESTATUTO ACADÉMICO: INVESTIGADOR SÉNIOR</p>
      </div>
    </div>
  );
}
...
function Heading() {
  return (
    <div className="content-stretch flex flex-col items-start relative shrink-0 w-full" data-name="Heading 1">
      <div className="flex flex-col font-['IBM_Plex_Sans:Bold',sans-serif] font-bold justify-center leading-[0] relative shrink-0 text-[#8b1e2d] text-[48px] tracking-[-2.4px] w-full" style={{ fontVariationSettings: "'wdth' 100" }}>
        <p className="leading-[48px]">Dr. José Ndele</p>
      </div>
    </div>
  );
}
...
function Container6() {
  return (
    <div className="content-stretch flex flex-col items-start max-w-[672px] relative shrink-0 w-full" data-name="Container">
      <div className="flex flex-col font-['Source_Sans_3:Regular',sans-serif] font-normal justify-center leading-[0] relative shrink-0 text-[#574142] text-[18px] w-full">
        <p className="leading-[28px] mb-0">Principal contribuidor do Repositório de Moeda do Século XIX. Especialista em transições</p>
        <p className="leading-[28px] mb-0">macroeconómicas do centro comercial de Luanda. Atualmente a perseguir a distinção</p>
        <p className="leading-[28px]">{`"Arquivo de Ouro".`}</p>
      </div>
    </div>
  );
}
...
function Margin() {
  return (
    <div className="content-stretch flex flex-col items-start max-w-[672px] pb-[24px] relative shrink-0 w-[672px]" data-name="Margin">
      <Container6 />
    </div>
  );
}
...
function Button1() {
  return (
    <div className="bg-[#8b1e2d] content-stretch flex flex-col items-center justify-center px-[24px] py-[9px] relative rounded-[4px] shrink-0" data-name="Button">
      <div className="flex flex-col font-['Source_Sans_3:SemiBold',sans-serif] font-semibold justify-center leading-[0] relative shrink-0 text-[16px] text-center text-white whitespace-nowrap">
        <p className="leading-[24px]">Editar Bio Académica</p>
      </div>
    </div>
  );
}
...
function Button2() {
  return (
    <div className="content-stretch flex flex-col items-center justify-center px-[25px] py-[9px] relative rounded-[4px] shrink-0" data-name="Button">
      ...
      <div className="flex flex-col font-['Source_Sans_3:SemiBold',sans-serif] font-semibold justify-center leading-[0] relative shrink-0 text-[#6b0119] text-[16px] text-center whitespace-nowrap">
        <p className="leading-[24px]">Descarregar Portfólio</p>
      </div>
    </div>
  );
}
...
function Container3() {
  return (
    <div className="col-[4/span_9] content-stretch flex flex-col items-start pb-[8px] relative row-1 self-end shrink-0 w-[876px]" data-name="Container">
      <Container4 />
    </div>
  );
}

function ProfileHeaderEditorialAsymmetry() {
  return (
    <div className="gap-x-[48px] gap-y-[48px] grid grid-cols-[repeat(12,minmax(0,1fr))] grid-rows-[_262.50px] relative shrink-0 w-full" data-name="Profile Header: Editorial Asymmetry">
      <BackgroundShadow />
      <Container3 />
    </div>
  );
  ...
  return (
    <div className="relative shrink-0 w-full" data-name="Container">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex flex-col items-start relative size-full">
        <div className="flex flex-col font-['Source_Sans_3:Bold',sans-serif] font-bold justify-center leading-[0] relative shrink-0 text-[#574142] text-[11px] tracking-[1.1px] uppercase w-full">
          <p className="leading-[16.5px]">PONTUAÇÃO ACADÉMICA TOTAL</p>
        </div>
      </div>
    </div>
  );
...
function Paragraph() {
  return (
    <div className="relative shrink-0 w-full" data-name="Paragraph">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex gap-[8px] items-baseline leading-[0] relative size-full whitespace-nowrap">
        <div className="flex flex-col font-['Source_Sans_3:Bold',sans-serif] font-bold justify-center relative shrink-0 text-[#6b0119] text-[48px]">
          <p className="leading-[48px]">12.450</p>
        </div>
        <div className="flex flex-col font-['Source_Sans_3:Medium',sans-serif] font-medium justify-center relative shrink-0 text-[#94a3b8] text-[14px]">
          <p className="leading-[20px]">pts</p>
        </div>
      </div>
    </div>
  );
...
function Background1() {
  return (
    <div className="bg-[#f1f5f9] h-[6px] relative rounded-[12px] shrink-0 w-full" data-name="Background">
      <div className="absolute bg-[#6b0119] bottom-0 left-0 right-1/4 rounded-[12px] top-0" data-name="Background" />
    </div>
  );
}
...
function BackgroundHorizontalBorder() {
  return (
    <div className="bg-white col-1 h-[192px] justify-self-stretch relative rounded-[8px] row-1 shrink-0" data-name="Background+HorizontalBorder">
      <div aria-hidden="true" className="absolute border-[rgba(107,1,25,0.1)] border-b-2 border-solid inset-0 pointer-events-none rounded-[8px]" />
      <div className="content-stretch flex flex-col items-start justify-between pb-[34px] pt-[31px] px-[32px] relative size-full">
        <Container8 />
        <Paragraph />
        <Margin1 />
      </div>
...
function Container9() {
  return (
    <div className="content-stretch flex flex-col items-start relative shrink-0 w-full" data-name="Container">
      <div className="flex flex-col font-['Source_Sans_3:Bold',sans-serif] font-bold justify-center leading-[0] relative shrink-0 text-[#574142] text-[11px] tracking-[1.1px] uppercase w-full">
        <p className="leading-[16.5px]">QUESTIONÁRIOS CONCLUÍDOS</p>
      </div>
    </div>
  );
}
...
function Paragraph1() {
  return (
    <div className="content-stretch flex gap-[8px] items-baseline leading-[0] relative shrink-0 w-full whitespace-nowrap" data-name="Paragraph">
      <div className="flex flex-col font-['Source_Sans_3:Bold',sans-serif] font-bold justify-center relative shrink-0 text-[#8b1e2d] text-[48px]">
        <p className="leading-[48px]">142</p>
      </div>
      <div className="flex flex-col font-['Source_Sans_3:Medium',sans-serif] font-medium justify-center relative shrink-0 text-[#94a3b8] text-[14px]">
        <p className="leading-[20px]">avaliações</p>
      </div>
    </div>
  );
}
...
function Container10() {
  return (
    <div className="content-stretch flex flex-col items-start relative shrink-0 w-full" data-name="Container">
      <div className="flex flex-col font-['Source_Sans_3:Italic',sans-serif] font-normal italic justify-center leading-[0] relative shrink-0 text-[#574142] text-[12px] w-full">
        <p className="leading-[16px]">Top 5% de investigadores ativos</p>
      </div>
    </div>
  );
}
...
function Background2() {
  return (
    <div className="bg-white col-2 h-[192px] justify-self-stretch relative rounded-[8px] row-1 shrink-0" data-name="Background">
      <div className="content-stretch flex flex-col items-start justify-between pb-[32px] pt-[31px] px-[32px] relative size-full">
        <Container9 />
        <Paragraph1 />
        <Margin2 />
      </div>
...
function Container11() {
  return (
    <div className="content-stretch flex flex-col items-start relative shrink-0 w-full" data-name="Container">
      <div className="flex flex-col font-['Source_Sans_3:Bold',sans-serif] font-bold justify-center leading-[0] relative shrink-0 text-[11px] text-[rgba(255,255,255,0.7)] tracking-[1.1px] uppercase w-full">
        <p className="leading-[16.5px]">RANKING GLOBAL DO ARQUIVO</p>
      </div>
    </div>
  );
}
...
function Paragraph2() {
  return (
    <div className="content-stretch flex gap-[8px] items-baseline leading-[0] relative shrink-0 w-full whitespace-nowrap" data-name="Paragraph">
      <div className="flex flex-col font-['Source_Sans_3:Bold',sans-serif] font-bold justify-center relative shrink-0 text-[48px] text-white">
        <p className="leading-[48px]">#12</p>
      </div>
      <div className="flex flex-col font-['Source_Sans_3:Medium',sans-serif] font-medium justify-center relative shrink-0 text-[14px] text-[rgba(255,255,255,0.5)]">
        <p className="leading-[20px]">mundial</p>
      </div>
    </div>
  );
}
  ...
  return (
    <div className="h-[6px] relative shrink-0 w-[10px]" data-name="Container">
      <svg className="absolute block inset-0 size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 10 6">
        <g id="Container">
          <path d={svgPaths.p313692c0} fill="var(--fill-0, white)" fillOpacity="0.9" id="Icon" />
        </g>
      </svg>
    </div>
  );
...
function Container14() {
  return (
    <div className="content-stretch flex flex-col items-start relative shrink-0" data-name="Container">
      <div className="flex flex-col font-['Source_Sans_3:Regular',sans-serif] font-normal justify-center leading-[0] relative shrink-0 text-[14px] text-[rgba(255,255,255,0.9)] whitespace-nowrap">
        <p className="leading-[20px]">+2 posições este mês</p>
      </div>
    </div>
  );
}
...
function Background3() {
  return (
    <div className="bg-[#8b1e2d] col-3 h-[192px] justify-self-stretch relative rounded-[8px] row-1 shrink-0" data-name="Background">
      <div className="content-stretch flex flex-col items-start justify-between pb-[32px] pt-[31px] px-[32px] relative size-full">
        <Container11 />
        <Paragraph2 />
        <Container12 />
...
function Container15() {
  return (
    <div className="content-stretch flex flex-col items-start relative shrink-0 w-full" data-name="Container">
      <div className="flex flex-col font-['Source_Sans_3:Bold',sans-serif] font-bold justify-center leading-[0] relative shrink-0 text-[#574142] text-[11px] tracking-[1.1px] uppercase w-full">
        <p className="leading-[16.5px]">CONTRIBUIÇÕES PARA O ARQUIVO</p>
      </div>
    </div>
  );
}
...
function Paragraph3() {
  return (
    <div className="content-stretch flex gap-[8px] items-baseline leading-[0] relative shrink-0 w-full whitespace-nowrap" data-name="Paragraph">
      <div className="flex flex-col font-['Source_Sans_3:Bold',sans-serif] font-bold justify-center relative shrink-0 text-[#8b1e2d] text-[48px]">
        <p className="leading-[48px]">28</p>
      </div>
      <div className="flex flex-col font-['Source_Sans_3:Medium',sans-serif] font-medium justify-center relative shrink-0 text-[#94a3b8] text-[14px]">
        <p className="leading-[20px]">docs verificados</p>
      </div>
    </div>
  );
}
...
function Container16() {
  return (
    <div className="content-stretch flex flex-col items-start relative shrink-0 w-full" data-name="Container">
      <div className="flex flex-col font-['Source_Sans_3:Regular',sans-serif] font-normal justify-center leading-[0] relative shrink-0 text-[#574142] text-[12px] w-full">
        <p className="leading-[16px]">Precisão Histórica: 98.4%</p>
      </div>
    </div>
  );
}
...
function Background4() {
  return (
    <div className="bg-white col-4 h-[192px] justify-self-stretch relative rounded-[8px] row-1 shrink-0" data-name="Background">
      <div className="content-stretch flex flex-col items-start justify-between pb-[32px] pt-[31px] px-[32px] relative size-full">
        <Container15 />
        <Paragraph3 />
        <Margin3 />
...
function SectionStatsGridBentoLayout() {
  return (
    <div className="gap-x-[24px] gap-y-[24px] grid grid-cols-[repeat(4,minmax(0,1fr))] grid-rows-[_192px] relative shrink-0 w-full" data-name="Section - Stats Grid: Bento Layout">
...
function LowerSectionDistinctionsSettings() {
  return (
    <div className="gap-x-[48px] gap-y-[48px] grid grid-cols-[repeat(3,minmax(0,1fr))] grid-rows-[_466px] relative shrink-0 w-full" data-name="Lower Section: Distinctions & Settings">
...
function MainContentCanvas() {
  return (
    <div className="max-w-[1536px] relative shrink-0 w-full" data-name="Main Content Canvas">
      <div className="content-stretch flex flex-col gap-[64px] items-start max-w-[inherit] p-[48px] relative size-full">
        <ProfileHeaderEditorialAsymmetry />
        <SectionStatsGridBentoLayout />
        <LowerSectionDistinctionsSettings />
      </div>
    </div>
  );
}
  ...
  return (
    <div className="content-stretch flex flex-col items-start relative shrink-0 w-full" data-name="Container">
      <div className="flex flex-col font-['Source_Sans_3:Regular',sans-serif] font-normal justify-center leading-[0] relative shrink-0 text-[#64748b] text-[14px] w-full">
        <p className="leading-[20px] mb-0">Preservando o património financeiro e</p>
        <p className="leading-[20px] mb-0">económico de Angola através do rigor</p>
        <p className="leading-[20px]">académico e da acessibilidade digital.</p>
      </div>
    </div>
  );
}
...
function Container43() {
  return (
    <div className="col-1 justify-self-stretch relative row-1 self-start shrink-0" data-name="Container">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex flex-col gap-[24px] items-start pb-[20.5px] relative size-full">
        <Container44 />
        <Container45 />
      </div>
    </div>
  ...
  return (
    <div className="content-stretch flex flex-col items-start relative shrink-0 w-full" data-name="Heading 4">
      <div className="flex flex-col font-['Source_Sans_3:Bold',sans-serif] font-bold justify-center leading-[0] relative shrink-0 text-[#7f1d1d] text-[11px] tracking-[1.1px] uppercase w-full">
        <p className="leading-[16.5px]">EXPLORAR</p>
      </div>
    </div>
  );
}
...
function Item2() {
  return (
    <div className="content-stretch flex flex-col items-start relative shrink-0 w-full" data-name="Item">
      <div className="flex flex-col font-['Source_Sans_3:Regular',sans-serif] font-normal justify-center leading-[0] relative shrink-0 text-[#64748b] text-[14px] w-full">
        <p className="leading-[20px]">Arquivo de Conteúdos</p>
      </div>
    </div>
  );
}
...
function Heading10() {
  return (
    <div className="content-stretch flex flex-col items-start relative shrink-0 w-full" data-name="Heading 4">
      <div className="flex flex-col font-['Source_Sans_3:Bold',sans-serif] font-bold justify-center leading-[0] relative shrink-0 text-[#7f1d1d] text-[11px] tracking-[1.1px] uppercase w-full">
        <p className="leading-[16.5px]">INFORMAÇÃO</p>
      </div>
    </div>
  );
}
...
function Item5() {
  return (
    <div className="content-stretch flex flex-col items-start relative shrink-0 w-full" data-name="Item">
      <div className="flex flex-col font-['Source_Sans_3:Regular',sans-serif] font-normal justify-center leading-[0] relative shrink-0 text-[#64748b] text-[14px] w-full">
        <p className="leading-[20px]">Política de Cookies</p>
      </div>
    </div>
  );
}
...
function Heading11() {
  return (
    <div className="content-stretch flex flex-col items-start relative shrink-0 w-full" data-name="Heading 4">
      <div className="flex flex-col font-['Source_Sans_3:Bold',sans-serif] font-bold justify-center leading-[0] relative shrink-0 text-[#7f1d1d] text-[11px] tracking-[1.1px] uppercase w-full">
        <p className="leading-[16.5px]">APOIO</p>
      </div>
    </div>
  );
}
...
function Item6() {
  return (
    <div className="content-stretch flex flex-col items-start relative shrink-0 w-full" data-name="Item">
      <div className="flex flex-col font-['Source_Sans_3:Regular',sans-serif] font-normal justify-center leading-[0] relative shrink-0 text-[#64748b] text-[14px] w-full">
        <p className="leading-[20px]">Contactar o Arquivo</p>
      </div>
    </div>
  );
}
...
function Item7() {
  return (
    <div className="content-stretch flex flex-col items-start relative shrink-0 w-full" data-name="Item">
      <div className="flex flex-col font-['Source_Sans_3:Regular',sans-serif] font-normal justify-center leading-[0] relative shrink-0 text-[#64748b] text-[14px] w-full">
        <p className="leading-[20px]">Suporte Técnico</p>
      </div>
    </div>
  );
}
...
function Item8() {
  return (
    <div className="content-stretch flex flex-col items-start relative shrink-0 w-full" data-name="Item">
      <div className="flex flex-col font-['Source_Sans_3:Regular',sans-serif] font-normal justify-center leading-[0] relative shrink-0 text-[#64748b] text-[14px] w-full">
        <p className="leading-[20px]">Assistência de Investigação</p>
      </div>
    </div>
  );
}
...
function HorizontalBorder3() {
  return (
    <div className="max-w-[1536px] relative shrink-0 w-full" data-name="HorizontalBorder">
      ...
      <div className="gap-x-[48px] gap-y-[48px] grid grid-cols-[repeat(4,minmax(0,1fr))] grid-rows-[_132.50px] max-w-[inherit] pb-[96px] pt-[97px] px-[48px] relative size-full">
        <Container43 />
        <Container46 />
        <Container47 />
        <Container48 />
...
function Container49() {
  return (
    <div className="content-stretch flex flex-col items-center relative shrink-0 w-full" data-name="Container">
      <div className="flex flex-col font-['Source_Sans_3:Medium',sans-serif] font-medium justify-center leading-[0] relative shrink-0 text-[#64748b] text-[11px] text-center tracking-[1.1px] uppercase whitespace-nowrap">
...
export default function PerfilDoInvestigadorDesktop() {
  return (
    <div className="bg-[#f8f9ff] content-stretch flex flex-col gap-[4px] items-start relative size-full" data-name="Perfil do Investigador (Desktop)">
      <TopNavBarNavigationShell />
      <MainContentCanvas />
      <Footer />
    </div>
  );
